jQuery(function($) {
    var pagetree = {
        ...
        doExpandCollapseAll : function(id, mode) {
            ...
            var childDivs = containerDiv.find("div");
            ...
            jQuery("div.plugin_pagetree").each(
                    function(pagetreeId) {
                        if (pagetreeId == treeId) {
                            jQuery(this).find("span.plugin_pagetree_status").css("display", "inline");
                            jQuery(this).find("div.plugin_pagetree_expandcollapse").css("display", "none");
                        }
                    }
            );
        },
        ...
        finishLoadingMessage : function(id) {
            ...
            jQuery("div.plugin_pagetree").each(
                    function(pagetreeId) {
                        if (pagetreeId == treeId) {
                            jQuery(this).find("span.plugin_pagetree_status").css("display", "none");
                            jQuery(this).find("div.plugin_pagetree_expandcollapse").css("display", "inline");
                        }
                    }
            );
        },
        ...
        makePlusMinusButtonsClickable : function (pagetreeChildrenDiv) {
            pagetreeChildrenDiv.find("a.plugin_pagetree_childtoggle").each(
                    function() {
                        ...
                        jQueryThis.click(
                                function() {
                                    var childDiv = jQueryThis.parent().children("div[id]");
